...
export class Grok {
    ...
    async continueConversation(params: ContinueConversationParams): ConversationResponse {
        fetch(`https://grok.com/rest/app-chat/conversations/${params.conversationId}/responses`, {
            method: "POST",
