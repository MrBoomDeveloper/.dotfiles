...
export class Grok {
    ...
    async continueConversation(params: ContinueConversationParams): Promise<ContinueConversationResponse> {
        const response = await (await fetch("https://grok.com/rest/app-chat/conversations/db25589d-470e-4c8a-9327-d547f126d1f6/responses", {
            "headers": {
              "accept": "*/*",
