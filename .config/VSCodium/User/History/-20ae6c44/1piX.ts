...
const server = Bun.serve({
	...
	routes: {
		...
		// Temp route. TODO: Remove once uust will give us direct api access
		"/uustSchedule": async req => {
			return new Response(await (await fetch("https://dev.uust-time.ru/api/v/852971/schedule/0/9573/semester/241?site=schedule", {
				headers: {
					"Origin": "dev.uust-time.ru"
				}
			})).text())
		},
		...
		// CREATE TABLE notifications (target TEXT, title TEXT, message TEXT, date );
