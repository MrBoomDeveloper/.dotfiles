...
import { browsePlaylist } from "./api/browsePlaylist";
...
function renderUi() {
	...
	console.log(stripIndent(`
		...
		8. Stop
		9. Quit
		10. Load cookies - ex. 10 BROWSER_NAME
		11. Select playlist - ex. 11 PLAYLIST_URL
	`).trim());
			...
			case "11": (async () => {
				browsePlaylist(
					new YouTubeApi(
						...
						// "CgtacUhhR084ZnpkWSjMvcTIBjInCgJMVhIhEh0SGwsMDg8QERITFBUWFxgZGhscHR4fICEiIyQlJiBH"
					), 
